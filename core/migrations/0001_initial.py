...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='player',
            index=django.contrib.postgres.indexes.GinIndex(fields=['name'], name='player_name_6db881_gin'),
        ),
        migrations.AddIndex(
            model_name='player',
            index=django.contrib.postgres.indexes.GinIndex(fields=['club'], name='player_club_3acad4_gin'),
        ),
        migrations.AddIndex(
            model_name='player',
            index=django.contrib.postgres.indexes.GinIndex(fields=['nationality'], name='player_nationa_6ef8aa_gin'),
        ),
    ]
